...
# "Cloud image bootstrap, saltmaster"
#
# ssh into a new cloud server, update it, and run the lbaas-saltmaster-setup.sh script.
#
# First argument is the target machine name, e.g. "lbaas-prod-saltmaster-1",
